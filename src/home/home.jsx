...
<div>
    <nav class="navbar">
        ...
        <div class="nav-buttons">
            <a href="pages/login.html"><button class="btn btn-text">Sign In</button></a>
            <a href="pages/login.html"><button class="btn btn-primary">Get Started</button></a>
        </div>
    </nav>
    ...
    <section class="hero">
        ...
        <div class="hero-buttons">
            <NavLink className='nav-link' to='createpage'><button class="btn btn-secondary">Create New Group</button></NavLink>
