...
- [X] **All functionality implemented or mocked out** - I adequately completed this requirement according to Professor Clement
- [X] **Hooks** - I did implement this part of the deliverable. See src/hooks
