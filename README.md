...
- [X] **Calls to third party endpoints** - I added a quote of the day, third party endpoint call on my homepage. Set up the endpoint on my index.js file.
...
- [X] **Stores data in MongoDB** - I store my data on MongoDB.
- [X] **Stores credentials in MongoDB** - I store credentials on MongoDB.
